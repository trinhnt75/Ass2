...
const Signup = () => {
  ...
  return (
    <div className="grid grid-cols-2   mt-10 items-center  mx-auto w-full bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
      <div className="px-10 space-y-2 ">
        <h1 className="text-center items-center pt-5 text-3xl font-medium">Đăng ký</h1>
        <form
          action="#"
        ...
        >
          <div className="col-span-6 sm:col-span-3">
            ...
            <input
              {...register("firstName")}
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500 shadow-sm"
            />
          ...
          <div className="col-span-6 sm:col-span-3">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg  focus:outline-none focus:border-indigo-500 shadow-sm"
            />
            <p className="text-red-600 text-[10px]">
          ...
          <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
            <button className="inline-block shrink-0 rounded-md border border-[#FF4D4F] bg-[#FF4D4F] w-[50%] py-3 text-sm  text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500">
              Đăng kí
            </button>
        ...
        <div className="my-10">
          <div className="my-10">
            <span className="text-center my-4 block">Hoặc đăng nhập bằng</span>
            <button
      ...
      <div className=" px-10  items-center text-center">
        <img src="/logo.jpg/" alt="" className="inline-block w-[700px]" />
      </div>
    </div>
  );
};
