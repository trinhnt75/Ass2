  ...
  return (
    <div className="grid grid-cols-2   mt-10 items-center  mx-auto w-full  bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
      <div className="px-10 space-y-2 ">
        <h1 className="text-center items-center pt-5 text-3xl font-medium">Đăng nhập</h1>
        <form
          action="#"
        ...
        >
          ...
          <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
            <button className="inline-block  shrink-0 rounded-md border border-[#FF4D4F] bg-[#FF4D4F] w-full py-3 text-lg  text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500">
              Đăng nhập
            </button>
          </div>
        </form>
        <div className="my-10">
          <div className="my-10 text-center items-center">
            ...
            >
              ...
              <p className="text-base text-center items-center font-medium ml-4 text-gray-700">
